...
using Utility = RealEstate.Application.Helpers.Util;

namespace RealEstate.Infrastructure.JwtToken
{
    /// <summary>
    ...
    public sealed class TokenGenerator : ITokenGenerator
    {
        ...
        public async Task<Result<AuthResponse>> VerifyRefreshToken(string RefreshToken)
        {
            try
            {
                ...
                string fullName = $"{dbUser.LastName} {dbUser.FirstName}";
